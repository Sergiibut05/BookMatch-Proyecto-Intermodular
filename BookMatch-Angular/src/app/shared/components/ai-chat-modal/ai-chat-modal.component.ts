...
@Component({
  ...
  styleUrl: './ai-chat-modal.component.scss'
})
export class AiChatModalComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  private getBaseUrl(): string {
    ...
    // Si está en localhost, solo la parte de localhost:4200
    // Si está desplegado, solo la parte del dominio
    return currentUrl + '/';
  }
